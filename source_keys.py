...
ASSISTANT_ID_152FZ = os.getenv("ASSISTANT_ID_152FZ")  # Получаем идентификатор ассистента OpenAI
TELEGRAM_152FZ_TOKEN = os.getenv("TELEGRAM_152FZ_TOKEN")  # Получаем токен для Telegram-бота
GIGACHAT_CREDENTIALS = os.getenv("API_KEY_GIGA")  # Получаем учетные данные для GigaChat
